...
public class EmbeddedSQL {
   ...
   public static void Query1(EmbeddedSQL esql){
      try{
         String query = "SELECT S.sname, count(*) FROM Suppliers S, Parts P, Catalog C WHERE S.sid=C.sid AND C.pid=P.pid GROUP BY S.sid";
	 int rowCount = esql.executeQuery(query);
	System.out.println("total row(s): " + rowCount);
      }catch(Exception e){
         System.err.println(e.getMessage());
   ...
   public static void Query2(EmbeddedSQL esql){
      try{
         String query = "SELECT S.sname, count(*) FROM Suppliers S, Parts P, Catalog C WHERE S.sid=C.sid AND C.pid=P.pid GROUP BY S.sid HAVING count(*)>=3";
         int rowCount = esql.executeQuery(query);
        System.out.println("total row(s): " + rowCount);
      }catch(Exception e){
         System.err.println(e.getMessage());
   ...
   public static void Query3(EmbeddedSQL esql){
      try{
         String query = "SELECT S.sname, count(*) FROM Suppliers S WHERE S.sid IN (SELECT S.sid FROM Suppliers S, Parts P, Catalog C WHERE S.sid=C.sid AND C.pid=P.pid AND P.color='Green') AND S.sid NOT IN (SELECT S.sid FROM Suppliers S, Parts P, Catalog C WHERE S.sid=C.sid AND C.pid=P.pid AND P.color!='Green') GROUP BY S.sid";
       int rowCount = esql.executeQuery(query);
        System.out.println("total row(s): " + rowCount);
      }catch(Exception e){
         System.err.println(e.getMessage());
   ...
   public static void Query4(EmbeddedSQL esql){
      try{
         String query = "SELECT S.sname, MAX(C.cost) FROM Suppliers S, Catalog C WHERE S.sid=C.sid AND S.sid IN (SELECT S.sid FROM Suppliers S, Catalog C WHERE S.sid IN (SELECT S.sid FROM Suppliers S, Parts P, Catalog C WHERE S.sid=C.sid AND C.pid=P.pid AND P.color='Green') AND S.sid IN (SELECT S.sid FROM Suppliers S, Parts P, Catalog C WHERE S.sid=C.sid AND C.pid=P.pid AND P.color='Red') GROUP BY S.sid) GROUP BY S.sid";
       int rowCount = esql.executeQuery(query);
        System.out.println("total row(s): " + rowCount);
      }catch(Exception e){
         System.err.println(e.getMessage());
   ...
   public static void Query5(EmbeddedSQL esql){
      try{
         String query = "SELECT P.pname FROM Parts P, Catalog C WHERE C.pid=P.pid AND C.cost<";
         System.out.print("\tEnter cost: $");
         String input = in.readLine();
         query += input;
